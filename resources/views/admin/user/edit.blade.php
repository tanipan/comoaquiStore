            ...
            <div class="card card-success">
                ...
                <form method="POST" action="{{ route('admin.user.update', $user) }}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                value="{{ old('name', $user->name) }}" name="name" placeholder="Inserta el nombre">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                value="{{ old('email', $user->email) }}" name="email" placeholder="Inserta el email">
                            @error('email')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('role') is-invalid @enderror" id="role" name="role">
                                    ...
                                    <option {{ old('role', $user->role) == 'reviewer' ? 'selected' : '' }}
                                        value="reviewer">Revisor
                                    </option>
                                </select>
                            </div>
                            @error('role')
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary float-right">Modificar usuario</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
